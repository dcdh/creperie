...
public class AjouterPlatUseCase extends AbstractDomainUseCase<CommandeIdentifier, AjouterPlat, Commande> {

    public AjouterPlatUseCase(final CommandHandler<Commande, CommandeIdentifier> commandHandler) {
